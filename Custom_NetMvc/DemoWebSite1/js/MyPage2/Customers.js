...
$(function() {
	$('#grid1').datagrid({
		...
		url:'/Ajax/Customer/List.aspx',	
		columns:[[
			{title:'', field:'xx', align:'center', width: 40,
				formatter:function(value,row){ return '<a href="/Ajax/Customer/Delete.aspx?id=' + row.CustomerID + '" title="删除" class="easyui-linkbutton" plain="true"><img src="/Images/delete.gif" alt="删除" /></a>'; }
			},
