...
function btnQuery_Click(){
	...
	var url = '/Ajax/Order/Search2.aspx?' + $.param({StartDate: dateRange.StartDate, EndDate: dateRange.EndDate});
...
function ShowCustomerDialog(){
	...
	var url = "/Ajax/Customer/GetById.aspx?" + $.param({id: customerId});
	$.ajax({
...
function ShowOrderDialog(){
	...
	$.ajax({
		dataType: "json", url: "/Ajax/Order/GetById.aspx?id=" + orderId,
		success: function(json){
...
function ShowProductDialog(){
	...
	var url = "/Ajax/Product/GetById.aspx?" + $.param({id: productId});
...
function SubmitSetOrderStatus(){
	...
	$.ajax({
		url: "/Ajax/Order/SetOrderStatus.aspx",  type: "GET", dataType: "text",
