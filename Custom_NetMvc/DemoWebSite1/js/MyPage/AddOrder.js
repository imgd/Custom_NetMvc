...
$(function() {
    ...
    $('#btnPickProduct').click(function() {
        ShowPickerDialog('divProductList', '/Ajax/Product/ShowProductPicker.aspx', AddSelectedItemToTable, ShowProductPickerSuccess); return false;
    });
    $('#btnSubmit').click(btnSubmit_click);
});

function PickCustomerClick(){
	ShowPickerDialog('divCustomerList', '/Ajax/Customer/ShowCustomerPicker.aspx', ShowSelectedCustomer, ShowCustomerPickerSuccess); return false;
}
...
function ShowProductPickerSuccess(divId) {
    $('#btnProductPickerFilterByName').linkbutton({ iconCls: "icon-search" }).unbind().click(function() {
        ...
        var url = '/Ajax/Product/ShowProductPicker.aspx?' + paramString
...
function ShowCustomerPickerSuccess(divId) {
	$('#btnCustomerPickerFilterByName').linkbutton({iconCls: "icon-search"}).unbind().click(function() {
		...
		var url = "/Ajax/Customer/ShowCustomerPicker.aspx?" + paramString
