...
function btnQuery_Click(){
	...
	var url = '/Ajax/Order/Search.aspx?' + $.param({StartDate: dateRange.StartDate, EndDate: dateRange.EndDate});
...
function ShowCustomerDialog(){
	...
	var url = "/Ajax/Customer/Show.aspx?" + $.param({id: customerId});
...
function ShowOrderDialog(){
	...
	var url = "/Ajax/Order/Show.aspx?id=" + orderId;
...
function ShowProductDialog(){
	...
	var url = "/Ajax/Product/Show.aspx?" + $.param({id: productId});
